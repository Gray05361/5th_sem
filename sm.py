...
# Load the dataset
file_path = '/home/iemaimlcsbs017/Downloads/time_series_data_human_activities (2).csv'  # Replace with your CSV file path
df = pd.read_csv('/home/iemaimlcsbs017/Downloads/time_series_data_human_activities (2).csv')
